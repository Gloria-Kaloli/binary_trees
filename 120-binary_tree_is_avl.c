...
/**
 * binary_tree_is_avl - Function to check if tree is AVL
...
/**
 * recurse_for_height - Function to measure height
...
/**
 * recurse_for_is_bst - Function to recursive check for BST
